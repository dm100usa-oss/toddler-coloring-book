...
/* Книга этого сайта. Три издания: английское, испанское и русское.
   ...
   Английское и испанское издания выходят в бумаге, русское в виде
   файла для печати. У каждого издания свой зарегистрированный ISBN.
...
export const editions: Record<UiLang, Edition> = {
  ...
  ru: {
    ...
    /* Издание выходит файлом для печати, кнопки Amazon у него нет. */
    isbn: "978-1-963328-36-3",
    ...
    faq: [
      ...
      },
      {
        ...
        a:
          "Английское и испанское издания продаются на Amazon в бумаге. Русское издание " +
            "выпущено в виде файла для печати, ISBN 978-1-963328-36-3. Его можно " +
