  ...
  ru: {
    ...
    home: {
      ...
      lead:
        ...
        "морские жители, сказочные герои, транспорт, цветы и еда. Слово под каждым рисунком " +
        "тоже раскрашивается, и первые буквы приходят вместе с рисованием.",
      pickerTitle: "Какая раскраска подойдет вашему ребенку",
      pickerLead: "Четыре вопроса, около тридцати секунд. Ничего не сохраняется и никуда не уходит.",
      whatTitle: "Что это за сайт",
      whatText:
        "Сайт о самом первом этапе рисования: от первой черты до первой формы, которую ребенок " +
        "закрашивает осознанно. Все, что здесь сказано о возможностях ребенка в том или ином " +
        "возрасте, опирается на опубликованные нормы развития, источники названы внизу страницы. " +
        "Сайт ведет издательство Magic of Discoveries LLC из Майами, штат Флорида.",
      whyTitle: "Почему первая раскраска устроена не так, как обычная",
      why: [
        "Толщина линии решает все. Тонкий контур пропадает под карандашом, зажатым в кулаке, и ребенок не видит результата.",
        "Один рисунок на странице. Два-три предмета на листе делят внимание ребенка, которого хватает на несколько минут.",
        "Рисунок должен заполнять лист. Маленькая картинка посреди большой страницы требует точности, которой у руки еще нет.",
        "Предмет должен узнаваться. Малыш раскрашивает то, что может назвать, и половина интереса держится именно на этом.",
        "Печать с одной стороны. Фломастер проходит бумагу насквозь и на двусторонней странице портит следующий рисунок.",
      ],
      printablesTitle: "Бесплатные листы для печати",
      printablesLead:
        "Десять рисунков прямо из книги, в том же порядке. Распечатайте один, дайте ребенку " +
        "карандаш, и за пять минут станет понятно, подходит ли ему такая страница.",
      printablesCta: "Посмотреть все бесплатные листы",
      bookTitle: "Книга",
      bookLead:
        "Книга выходит в бумаге на английском и испанском, а на русском мы отдаем ее файлом " +
        "для печати дома.",
      bookCta: "О книге",
      sourcesTitle: "Откуда взяты данные о развитии",
      sourcesLead:
        "Возраст на этом сайте это обычный разброс, а не срок. Каждый ребенок приходит к этим " +
        "точкам в своем темпе, и несколько месяцев в любую сторону это норма.",
    },
    picker: {
      start: "Начать",
      ...
      lookForTitle: "На что смотреть в раскраске",
      tryTitle: "Распечатайте и попробуйте сегодня",
      tryLead: "Листы, подобранные для этого этапа. Бесплатно, без регистрации.",
      bookLine: "Наша книга для этого этапа",
      disclaimer:
        "Это общая справка по опубликованным нормам развития, а не оценка вашего ребенка. " +
        "Если вас что-то беспокоит в его развитии, поговорите с педиатром.",
      q: {
        age: {
          q: "Сколько лет ребенку?",
          a: [
        ...
        inside: {
          q: "Что происходит, когда ребенок раскрашивает?",
          a: [
            { value: "across", label: "Черты идут по всему листу" },
            { value: "near", label: "Попадает по рисунку, но выходит за контур" },
            { value: "inside", label: "В основном остается внутри контура" },
          ],
        },
        attention: {
          q: "Сколько ребенок занят одной страницей?",
          a: [
    ...
    footer: {
      about:
        "Toddler Coloring Book (Раскраска для малышей) выпускает издательство Magic of " +
        "Discoveries LLC из Майами, штат Флорида. Мы пишем о первом этапе рисования и издаем " +
        "раскраску для этого возраста.",
      catalog: "Наш каталог",
      rights: "Все рисунки на этом сайте наши собственные.",
    },
    common: {
      free: "Бесплатно",
      download: "Скачать",
