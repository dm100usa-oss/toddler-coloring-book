...
export const drawings: Drawing[] = [
  ...
  { n: 28, group: "land", name: { en: "Eagle", es: "Águila", ru: "Орёл" } },
  ...
  { n: 48, group: "water", name: { en: "Seahorse", es: "Hipocampo", ru: "Морской конёк" } },
  ...
  { n: 64, group: "fantasy", name: { en: "Magic cauldron", es: "Caldera mágica", ru: "Волшебный котёл" } },
  ...
  { n: 68, group: "vehicles", name: { en: "Helicopter", es: "Helicóptero", ru: "Вертолёт" } },
  { n: 69, group: "vehicles", name: { en: "Airplane", es: "Avión", ru: "Самолёт" } },
