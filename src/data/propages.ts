      ...
      metaTitle: "Испанская раскраска для логопедов и раннего развития",
        ...
        body: [
          "Испанское издание - отдельная версия книги. Рисунки в нем те же, что и в " +
            "английском, но под каждым изображением напечатано испанское слово полыми " +
      ...
      ru: {
        ...
        body: [
          ...
          "Для занятий не нужны принтер, ножницы или предварительная подготовка. Достаточно " +
            "книги и мелков или карандашей. Название под каждым рисунком напечатано полыми " +
      ...
      ru: {
        ...
        body: [
          "Когда взрослый и ребенок сидят за одним столом, одна страница может стать " +
            ...
            "ним и называет изображение. Название напечатано полыми буквами, поэтому его тоже " +
